...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_uiv__ = __webpack_require__(36);
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('example-component', __webpack_require__(37));

__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('event-modal', __webpack_require__(40));

__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('age-modal', __webpack_require__(43));
...
function toggleBodyOverflow(enable) {
  ...
  } else if (hasScrollbar(document.documentElement) || hasScrollbar(document.body)) {
...
var Tabs = { render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('section', [_c('ul', { staticClass: "nav nav-tabs", class: { 'nav-justified': _vm.justified }, attrs: { "role": "tablist" } }, [_vm._l(_vm.groupedTabs, function (tab, index) {
  ...
  methods: {
    ...
    hide: function hide() {
      ...
      if (this.isShown()) {
        ...
        this.timeoutId = setTimeout(function () {
          removeFromDom(_this3.$refs.popup);
          _this3.timeoutId = 0;
    ...
    handleAuto: function handleAuto() {
      ...
      setTimeout(function () {
        if (_this4.triggerEl.matches(':hover, :focus')) {
          _this4.show();
        } else {
          _this4.hide();
        }
...
var TimePicker = { render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('section', { on: { "click": function click($event) {
          $event.stopPropagation();
        } } }, [_c('table', [_c('tbody', [_c('tr', { staticClass: "text-center" }, [_c('td', [_c('btn', { attrs: { "type": "link", "size": "sm", "disabled": _vm.readonly }, on: { "click": function click($event) {
          _vm.changeTime(1, 1);
          ...
          _vm.changeTime(0, 1);
        } } }, [_c('i', { class: _vm.iconControlUp })])], 1), _vm._v(" "), _vm.showMeridian ? _c('td') : _vm._e()]), _vm._v(" "), _c('tr', [_c('td', { staticClass: "form-group" }, [_c('input', { directives: [{ name: "model", rawName: "v-model.lazy", value: _vm.hoursText, expression: "hoursText", modifiers: { "lazy": true } }], staticClass: "form-control text-center", staticStyle: { "width": "50px" }, attrs: { "type": "tel", "pattern": "\\d*", "placeholder": "HH", "readonly": _vm.readonly, "maxlength": "2", "size": "2" }, domProps: { "value": _vm.hoursText }, on: { "mouseup": _vm.selectInputValue, "keydown": [function ($event) {
        ...
        } } })]), _vm._v(" "), _vm.showMeridian ? _c('td', [_vm._v("   "), _c('btn', { attrs: { "data-action": "toggleMeridian", "disabled": _vm.readonly }, domProps: { "textContent": _vm._s(_vm.meridian ? _vm.t('uiv.timePicker.am') : _vm.t('uiv.timePicker.pm')) }, on: { "click": _vm.toggleMeridian } })], 1) : _vm._e()]), _vm._v(" "), _c('tr', { staticClass: "text-center" }, [_c('td', [_c('btn', { attrs: { "type": "link", "size": "sm", "disabled": _vm.readonly }, on: { "click": function click($event) {
          _vm.changeTime(1, 0);
          ...
          _vm.changeTime(0, 0);
        } } }, [_c('i', { class: _vm.iconControlDown })])], 1), _vm._v(" "), _vm.showMeridian ? _c('td') : _vm._e()])])])]);
...
var getTotalHeightOfQueue = function getTotalHeightOfQueue(queue) {
...
var Notification = { render: function render() {
  ...
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      ...
      el.style[_this.horizontal] = OFFSET + 'px';
  ...
  computed: {
    styles: function styles() {
      ...
      return _ref = {
        position: 'fixed'
      }, defineProperty(_ref, this.vertical, getTotalHeightOfQueue(queue, thisIndex) + 'px'), defineProperty(_ref, 'width', WIDTH + 'px'), defineProperty(_ref, 'transition', 'all ' + TRANSITION_DURATION / 1000 + 's ease-in-out'), _ref;
    },
        ...
        [
          ...
          _c(
            "p",
            {
              ...
              attrs: { align: "justify", id: "events-modal-description" }
            },
...
Component.options.__file = "resources/assets/js/components/AgeModal.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1598ab25", Component.options)
  } else {
    hotAPI.reload("data-v-1598ab25", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-1598ab25", module.exports)
  }
}
